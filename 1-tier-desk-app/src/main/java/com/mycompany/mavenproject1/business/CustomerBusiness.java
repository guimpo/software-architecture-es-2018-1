...
public class CustomerBusiness {
    ...
    public void create(Customer customer) throws Exception{
        if (isPhoneValid(customer.getPhone().length(), customer.getCountry().getDigits())){
            
            customer.setCreditLimit(setCreditLimit(customer.getAge(), customer.getCountry().getAcronym()));
